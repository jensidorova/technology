...
df <- data.frame(
  year = c(2015:2020),
  grant = c(1100, 2110, 6117, 5130, 2130, 7140),
...
df |>
  ...
  echarts4r::e_y_axis(name = "Y-Axis 1",
                      ...
                      formatter = htmlwidgets::JS("function (value) {return '$' + echarts.format.addCommas(value) + ' B'}")) |>
  e_line(percent, 
  ...
  e_tooltip(trigger = "axis",
            ...
            formatter = htmlwidgets::JS("
                                        ...
                                        params[0].marker + 'Grant: $' + echarts.format.addCommas(Math.round(params[0].value[1])) + ' B' + '<br/>' +
